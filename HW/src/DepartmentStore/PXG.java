...
public class PXG extends GolfWear implements golfWearPoint{
    private int point;
	...
	String pxgEvent() {
    	...
    	System.out.println();
	    System.out.println("PXG에서 현재 진행중인 이벤트를 확인하려면 y를 입력해주세요");
		...
		if (input.equals("y")) {
			...
			System.out.println("70만원 상당의 PXG 골프백을 100원에 구매할 수 있는 특별한 기회!");
    ...
    String bestItem() {
		Scanner scan = new Scanner(System.in);
    	System.out.println();
	    System.out.println("PXG에서 가장 인기있는 제품을 확인해보시겠습니까? 네/아니오");
