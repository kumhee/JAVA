...
public class Recto extends Casual implements CasualPoint{
    private int point;
	...
	String rectoEvent() {
    	...
    	System.out.println();
	    System.out.println("RECTO에서 현재 진행중인 이벤트를 확인하려면 y를 입력해주세요");
		...
		if (input.equals("y")) {
			...
			System.out.println("100만원 상당의 RECTO 아우터를 100원에 구매할 수 있는 특별한 기회!");
